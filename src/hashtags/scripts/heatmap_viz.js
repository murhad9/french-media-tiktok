...
export function drawXAxis (xScale) {
  ...
  d3.select('#hashtags-graph-g .x').call(xAxisGenerator)
}
...
export function rotateYTicks () {
  // TODO : Rotate Y ticks.
  d3.selectAll('#hashtags-graph-g .y .tick').attr('transform', function () {
...
export function updateRects (xScale, yScale, colorScale, targetColumn) {
  ...
  d3.selectAll('#hashtags-graph-g .cell')
    .attr(
      'transform',
